...
- **Electron GUI** — Non-developer entry point (Phase 3), chat/sessions/tool status/settings (80% daily use)
  ...
  - Unit tests `npm test` (35: 22 daemon_client + 7 integration + 6 renderer smoke); RESPONSE_TYPES mirror daemon protocol verified against `daemon.py`
...
GUI: `cd emrg/gui && npm test` (35: 22 daemon_client + 7 integration + 6 renderer smoke) — syntax: `node --check main.js preload.js daemon_client.js renderer/js/*.js`
