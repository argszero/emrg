...
GUI: `cd emrg/gui && npm test` (92: 45 daemon_client + 20 conn-manager + 8 integration + 6 build-config + 7 gui-state + 3 preload-api + 3 boot-contract) — syntax: `node --check main.js preload.js daemon_client.js`
