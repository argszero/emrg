...
export const ZH_DICT: Record<string, string> = {
  ...
  "composer.sandboxShortReadOnly": "只读",
  "composer.sandboxShortWorkspaceWrite": "可写",
  "composer.sandboxShortFullAccess": "全放行",
  ...
  "tool.pwsh.doing": "正在运行命令…",
  "tool.pwsh.done": "已运行命令",
...
export const EN_DICT: Record<string, string> = {
  ...
  "composer.sandboxShortReadOnly": "Read-only",
  "composer.sandboxShortWorkspaceWrite": "Writable",
  "composer.sandboxShortFullAccess": "Full access",
  ...
  "tool.pwsh.doing": "Running a command…",
  "tool.pwsh.done": "Command run",
  ...
  "chat.interrupted": "⏹ Interrupted — response stopped.",
