...
> - Release v0.2.26 (#686 宿主 rant 2026-08-11T18:16:52：master 自 v0.2.25 以来 10 commits / 8 PRs（#676-#685），宿主确认发布下一版本；版本号 0.2.25→0.2.26 同步 7 处（emrg/__init__.py、pyproject.toml、uv.lock、gui/package.json×2、build-runtime.sh、make-installer.sh），grep 0.2.25 仅历史；pytest 694 + GUI 212 绿；Build Release v0.2.26 成功，7 assets（含 Windows zip #649），latest=v0.2.26；合并 f2ba4be) ✅
