...
#
# `zip` was pinned here with the reason above and has left it, the third row to do
# so: its archive is readable from the first *operand* — no flag grammar needed to
