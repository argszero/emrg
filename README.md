...
Quick checks: `uv run pytest tests/ -v` (currently 694 items) · `cd emrg/gui && npm test` (195: 43 daemon_client + 19 conn-manager + 22 app-commands + 74 renderer smoke + 15 i18n + 7 integration + 3 commands + 5 build-config + 7 gui-state)
