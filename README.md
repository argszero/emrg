...
npm test             # run Node tests (58: 22 daemon_client + 7 integration + 25 renderer smoke + 4 app-commands; integration runs in CI, local: npm run test:integration)
```
